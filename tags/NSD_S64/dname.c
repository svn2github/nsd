...
int
dname_compare(void const *vleft, void const *vright)
{
	dname_type const *left = (dname_type const *) vleft;
	dname_type const *right = (dname_type const *) vright;
...
const char *
dname_to_string_r(const dname_type *dname,
